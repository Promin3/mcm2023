...
toolbox.decorate("evaluate", tools.DeltaPenalty(check_distance_to_origin, 10000000000000000000000))
...
# 可以选择将筛选后的数据保存为新的文件
filtered_data.to_excel('A/filtered_coordinates.xlsx', index=False)
